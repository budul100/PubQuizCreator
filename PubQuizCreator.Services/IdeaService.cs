...
{
    public class IdeaService(AppDbContext db)
    {
        ...
        public async Task<Idea?> GetAsync(Guid id, CancellationToken ct = default) => await db.Ideas
            .Include(i => i.Category)
            .FirstOrDefaultAsync(i => i.Id == id, ct);

        public async Task<List<Idea>> GetOpenAsync(CancellationToken ct = default) => await db.Ideas
            .Include(i => i.Category)
